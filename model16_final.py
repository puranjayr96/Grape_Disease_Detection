...
def load_bottleneck_data():
    ...
    h5f = h5py.File('bftx_vgg16.h5', 'r')
    X_train2 = h5f['bftx'][:]
    h5f.close()
    h5f = h5py.File('bfvx_vgg16.h5', 'r')
    X_val2 = h5f['bfvx'][:]
    h5f.close()
    with open('bfty_vgg16.pkl', 'rb') as f:
        y_train2 = pickle.load(f)
    with open('bfvy_vgg16.pkl', 'rb') as f:
...
with tf.Session() as sess:
    ...
    if ans == 'y':
        model.save_weights('vgg16_grapes_bottleneck_weights_temp.h5')
        print("Saved")
